...
class ImpfRiverFlood(ImpactFunc):
    ...
    def from_jrc_region_sector(cls, region, sector="residential"):
        ...
        sector: str
            ...
            "commercial", "industrial", "transport", "infrastructure", "custom".
        ...
        if sector == 'residential':
            ...
            impf_values, impf_id = from_jrc_impf_custom(region)
...
def from_jrc_impf_custom(region):
    """Create a new ImpfRiverFlood object for the custom sector of the a given world region.
...
def flood_imp_func_set():
    ...
    impf_europe_Res = ImpfRiverFlood.from_jrc_region_sector("Europe", sector="residential")
    impf_europe_Com = ImpfRiverFlood.from_jrc_region_sector("Europe", sector="commercial")
    impf_europe_Ind = ImpfRiverFlood.from_jrc_region_sector("Europe", sector="industrial")
    impf_europe_Tra = ImpfRiverFlood.from_jrc_region_sector("Europe", sector="transport")
    impf_europe_Inf = ImpfRiverFlood.from_jrc_region_sector("Europe", sector="infrastructure")
    impf_europe_Cus = ImpfRiverFlood.from_jrc_region_sector("Europe", sector="custom")
